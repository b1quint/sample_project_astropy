...
PACKAGENAME = metadata.get('package_name', 'sample_project_astropy')
DESCRIPTION = metadata.get('description', 'sample project astropy')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: sample_project_astropy requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
